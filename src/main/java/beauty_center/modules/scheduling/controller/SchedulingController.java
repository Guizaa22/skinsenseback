 ...
 * Provides endpoints for checking employee availability for booking
 * appointments.
 */
@RestController
@RequestMapping("/api")
...
public class SchedulingController {
         ...
         *
         * Example: GET
         * /api/availability?employeeId=...&serviceId=...&date=2024-02-15&days=7
         */
        ...
        public ResponseEntity<ApiResponse<AvailabilityResponse>> getAvailability(
                ...
                log.info("Availability request for service {} (employee: {}) from {} for {} days",
                                serviceId, employeeId, date, days);
                ...
                if (employeeId != null) {
                        ...
                        availableSlots = availabilityService.getAvailableSlotsForService(
                                        serviceId, date, days);
                }
