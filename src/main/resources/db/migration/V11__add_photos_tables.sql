-- V11: Add client_photo and service_photo tables for before/after and service images
...
CREATE INDEX idx_client_photo_client ON client_photo(client_id);
CREATE INDEX idx_client_photo_label ON client_photo(label);
...
CREATE INDEX idx_service_photo_service ON service_photo(service_id);